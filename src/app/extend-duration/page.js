    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-pink-50 to-rose-100 p-4 flex items-center">
      <div className="max-w-md mx-auto w-full">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-pink-600">Extend Time</h2>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-700">How long will you extend the locker?</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-pink-100 hover:bg-pink-200 text-pink-700 font-semibold py-3 px-6 rounded-2xl transition duration-200"
            >
              Cancel
            </button>
          </div>
...
export default ExtendDurationPage;
